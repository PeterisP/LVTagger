...
public class CoreAnnotations {
  ...
  /**
   * Latvian morphology analysis data
   */
  public static class LVMorphologyAnalysis implements CoreAnnotation<lv.semti.morphology.analyzer.Word> {
    public Class<lv.semti.morphology.analyzer.Word> getType() {
      return lv.semti.morphology.analyzer.Word.class;
    }
  }
